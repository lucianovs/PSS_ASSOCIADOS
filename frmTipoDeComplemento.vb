...
Public Class frmTipoDeComplemento
    ...
    Private Sub TratarObjetos()
        ...
        lblModeloComplemento.Enabled = bAlterar
        cbModeloComplemento.Enabled = bAlterar
        ...
        If i > -1 And Not bIncluir Then
            ...
            If dt.Rows(i).Item("UN002_DESCPL") = "C" Then
                cbModeloComplemento.Text = "C – Com vínculo ao Cadastro de Associados"
            Else
                cbModeloComplemento.Text = "S – Sem Vínculo ao Cadastro de Associados"
            End If
        ...
        If ConectarBanco() Then
            ...
            If Validardados(cMensagem) Then
                If bIncluir Then
                    ...
                    cSql = "INSERT INTO EUN002 (UN002_TIPCPL, UN002_DESCPL, UN002_MODCPL)"
                    cSql += " values (" & nProxCod_Registro.ToString & ",'" & txtDescricao.Text & "', '" & Microsoft.VisualBasic.Left(cbModeloComplemento.Text, 1) & "')"

                ElseIf bAlterar Then
                    cSql = "UPDATE EUN002 set UN002_DESCPL='" & Trim(txtDescricao.Text) & _
                            "', UN002_MODCPL='" & Microsoft.VisualBasic.Left(cbModeloComplemento.Text, 1) & _
    ...
    Private Function Validardados(ByRef cMensagem As String) As Boolean
        ...
        If Not cbModeloComplemento.Text.StartsWith("C") And _
                Not cbModeloComplemento.Text.StartsWith("S") Then
            cMensagem += " <O modelo do complemento é inválido> "
            bRetorno = False
        End If
